...
public class HeadObj extends GameObj{
    ...
    public HeadObj(Image img, int x, int y, SnackGame frame) {
        super(img, x, y, frame);
        //键盘监听事件
    ...
    public void panitSelf(Graphics g) {
        ...
        move();
        //move结束后，新的bodyObj对象添加到bodyObjList当中
        if(newX != null && newY != null){
            this.frame.bodyObjList.add(new BodyObj(GameUtils.foodImg,newX,newY,this.frame));
        }
        //越界处理
        if(x<0){
            x = 570;
